...
EXCLUDED_PATH_PREFIXES = {
    ...
    "workspace",
    "__pycache__",
    # Local/private project memory and historical planning notes. These files
    # can remain in a developer checkout, but they are not part of a public
    # source checkpoint.
    "AGENT.md",
    "AGENTS.md",
    "docs/analysis-taptap-maker-plus.md",
    "docs/CHANGELOG.md",
    "docs/architecture/agent-core-health-audit-2026-06-26.md",
    ...
    "docs/persona.md",
    "docs/seven-grand-goals.md",
    "docs/sprint-board.md",
    "docs/tauri-migration.md",
    "docs/v0.6.0-module-index.md",
    "docs/v0.7.0-grand-plan.md",
    "docs/v0.7.1-electron-removal.md",
    "docs/v0.7.2-rust-hot-path.md",
    "docs/v0.7.3-http-bridge.md",
    "docs/v0.8.0-tauri-integration.md",
    "docs/v0.9.0-cross-platform.md",
    "docs/v1.0.0-auto-update.md",
    "docs/v1.0.0-release-checklist.md",
    "docs/v1.1.0-code-signing.md",
    "docs/v1.2.0-e2e-tests.md",
    "docs/v1.3.0-i18n.md",
    "docs/v1.5.0-bug-report.md",
    "docs/releases/v0.4.1-completion-audit.md",
    "docs/releases/v0.4.1-runtime-readiness.md",
    "docs/releases/v0.4.2-onboarding-closure.md",
    "docs/releases/v0.4.3-maker-setup-chat-first.md",
    "docs/releases/v0.4.4-portable-agent-root.md",
    "docs/releases/v0.4.5-one-click-practice-entry.md",
    "docs/releases/v0.5.0-maker-self-healing.md",
    "docs/releases/v0.7.0-grand-release.md",
}
