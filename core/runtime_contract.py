...
def build_maker_briefing(contract: Dict[str, Any], task: str = "") -> Dict[str, Any]:
    ...
    return {
        ...
        "token_rule": "Use this briefing plus context_sync before fetching full tool lists or transcripts.",
    }
...
def render_maker_briefing_for_llm(briefing: Dict[str, Any], max_chars: int = 1100) -> str:
    ...
    compact = {
        ...
        "evidence_endpoints": {
            ...
            for key in ["context_sync", "runtime_metrics", "maker_guard", "commit_history", "mcp_status", "mcp_tools"]
